...
module.exports = grammar({
    ...
    // Указываем, что identifier — это "слово"
    word: $ => $._identifier,
    ...
    rules: {
        ...
        // Приватное лексическое правило — только для word
        _identifier: $ => token(/[a-zA-Z_][a-zA-Z0-9_]*/), // Регулярное выражение для идентификатора

        // Публичное правило — для использования в синтаксисе
